...
int main(){
    ...
    ListNode* head1 = createListNode(example1, 1);
    ListNode* head2 = createListNode(example2, 0);
    ListNode* head3 = createListNode(example3, -1);

    Solution solution;

    cout << solution.detectCycle(head1) << endl;
    cout << solution.detectCycle(head2) << endl;
    cout << solution.detectCycle(head3) << endl;
}
